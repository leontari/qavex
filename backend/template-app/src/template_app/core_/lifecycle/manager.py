...
from template_app.core_.lifecycle.registry import LifecycleRegistry
from template_app.core_.lifecycle.shutdown import shutdown
from template_app.core_.lifecycle.startup import startup
from template_app.core_.lifecycle.state import RuntimeState
from template_app.core_.lifecycle.tasks import BackgroundTaskManager
