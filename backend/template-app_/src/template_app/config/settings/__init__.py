...
from template_app.config_.settings.base import BaseAppSettings
from template_app.config_.settings.cors import CORSSettings
from template_app.config_.settings.database import DatabaseSettings
from template_app.config_.settings.jwt import JWTSettings
from template_app.config_.settings.redis import RedisSettings
